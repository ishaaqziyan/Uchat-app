...
use uchat_endpoint::{
    ...
    user::endpoint::{CreateUser, FollowUser, GetMyProfile, Login, UpdateProfile, ViewProfile, GetNotifications, MarkNotificationsAsRead, SendDirectMessage, GetConversations, GetDirectMessages},
    Endpoint,
};
